...
public class AttendanceController {
    ...
    public String unmarkAttendance(
            @RequestParam String email,
            @RequestParam Long eventId) {
        
        // Ensure only admin or authorized personnel are calling this, 
        // though role checks might be handled at security config layer.
        attendanceService.unmarkAttendance(email, eventId);
        return "Attendance unmarked successfully";
    }
}